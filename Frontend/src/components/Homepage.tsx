...
const CodeEditorHomepage: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Optimized for performance with instant syntax highlighting and auto-completion."
    },
    {
  ...
  const pricingPlans = [
    {
      ...
      price: "$0",
      period: "/month",
      features: ["Up to 3 collaborators", "5 projects", "Basic themes", "Community support"],
      popular: false
    },
    {
      name: "Pro",
      price: "$12",
      period: "/month",
      features: ["Unlimited collaborators", "Unlimited projects", "Premium themes", "Priority support", "Advanced debugging"],
      popular: true
    },
    {
      name: "Team",
      price: "$24",
      period: "/month",
      features: ["Everything in Pro", "Team management", "SSO integration", "Custom themes", "Dedicated support"],
      popular: false
    }
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full">
                  ...
                  <span className="text-sm text-blue-300">Now with AI-powered suggestions</span>
                </div>
                ...
                <p className="text-xl text-gray-300 max-w-lg leading-relaxed">
                  ...
                  Write, debug, and deploy together, anywhere in the world.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="bg-gray-900 rounded-2xl shadow-2xl border border-gray-700 p-6 transform rotate-1 hover:rotate-0 transition-transform duration-500">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4 text-sm text-gray-400">collaborative-project.js</div>
                </div>
                ...
                <div className="mt-8 flex items-center space-x-2">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 bg-blue-500 rounded-full border-2 border-gray-900 flex items-center justify-center text-xs font-semibold">A</div>
                    <div className="w-8 h-8 bg-green-500 rounded-full border-2 border-gray-900 flex items-center justify-center text-xs font-semibold">B</div>
                    <div className="w-8 h-8 bg-purple-500 rounded-full border-2 border-gray-900 flex items-center justify-center text-xs font-semibold">C</div>
                  </div>
                  <div className="text-sm text-gray-400">3 developers coding</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Everything you need to code collaboratively, from real-time editing to advanced debugging tools.
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group p-8 bg-gray-800/50 rounded-2xl border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:transform hover:scale-105">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <div key={index} className={`relative p-8 bg-gray-800/50 rounded-2xl border transition-all duration-300 hover:transform hover:scale-105 ${
                plan.popular ? 'border-blue-500 shadow-2xl shadow-blue-500/20' : 'border-gray-700 hover:border-gray-600'
              }`}>
                {plan.popular && (
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of developers who are already coding collaboratively with CodeSync.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                The future of collaborative coding is here. Build amazing things together.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 CodeSync. All rights reserved. Built with ❤️ for developers.
            </p>
          </div>
        </div>
      </footer>
