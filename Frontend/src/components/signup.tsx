          ...
          >
            {loading ? (
              <span className="flex items-center justify-center">
                ...
                We’ve sent an invitation email to your account. Please check your inbox and click the verification link to accept the invitation and log in to RTC Editor
              </span>
            ) : (
              "Create account"
            )}
