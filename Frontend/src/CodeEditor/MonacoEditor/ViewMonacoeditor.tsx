...
export default function MonacoEditor({
  ...
  useEffect(() => {
    setFileUsers([]); // Clear previous file users
      ...
      <div className="flex-1">
        <Editor
          ...
          options={{
            ...
            tabSize: 2,
            insertSpaces: true,
            formatOnPaste: false, // Disabled for read-only
            formatOnType: false,  // Disabled for read-only
            suggestOnTriggerCharacters: false, // Disabled for read-only
            acceptSuggestionOnEnter: "off",   // Disabled for read-only
            quickSuggestions: false,           // Disabled for read-only
          ...
          <div className="text-center">
            ...
            <p className="text-sm">
              {!selectedFile
                ...
                : "Select a file (not a folder) to view its contents"}
            </p>
