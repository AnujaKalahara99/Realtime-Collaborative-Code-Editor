...
//       {showMenu && (
//         <div
//           className={`${theme.surface} absolute right-4 top-12 z-50 border ${theme.border} rounded-md shadow-lg p-2 w-48`}
//           onClick={(e) => e.stopPropagation()}
//         >
//           <button
//             onClick={handleEdit}
//             className="flex items-center gap-2 text-sm text-blue-600 hover:text-blue-700 w-full px-3 py-2 rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors"
//           >
//             <Edit size={14} /> Edit
//           </button>
//           <button
//             onClick={handleShare}
//             className="flex items-center gap-2 text-sm text-green-600 hover:text-green-700 w-full px-3 py-2 rounded-md hover:bg-green-50 dark:hover:bg-green-900/50 transition-colors"
//           >
//             <Share2 size={14} /> Share
//           </button>
//           <button
//             onClick={handleDelete}
//             className="flex items-center gap-2 text-sm text-red-600 hover:text-red-700 w-full px-3 py-2 rounded-md hover:bg-red-50 dark:hover:bg-red-900/50 transition-colors"
//           >
//             <Trash2 size={14} /> Delete
//           </button>
//         </div>
...
//           } z-50 border ${theme.border} rounded-md shadow-lg p-2 w-48 transition-all duration-200 ease-in-out ${
//             showMenu
...
//   onEdit?: (newName: string) => void; // Update type
// }
...
//   const handleShare = (e: React.MouseEvent) => {
//     e.stopPropagation();
//     const newEmail = window.prompt("Enter email to share with:", "");
//     if (newEmail && onShare) onShare(newEmail.trim());
//     setShowMenu(false);
//   };
...
//     e.stopPropagation();
//     const newName = window.prompt("Enter new codespace name:", codespace.name);
//     if (newName && newName.trim()) { // Validate input
//       if (onEdit) onEdit(newName.trim());
//     } else {
