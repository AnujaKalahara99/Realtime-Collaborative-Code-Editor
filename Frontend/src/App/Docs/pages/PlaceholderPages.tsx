    ...
    <div className="max-w-4xl">
      ...
      <div className={`${theme.surfaceSecondary} p-8 rounded-lg text-left`}>
        {title === "Real-time Collaboration" && (
          <div>
            <p className={`${theme.textSecondary} pt-4`}>
            ...
            <ul className={`list-disc list-inside space-y-2 ${theme.textSecondary} mt-4`}>
              <li className="pt-2">Live cursors allow you to see where your teammates are editing in real-time.</li>
        ...
        {title === "Code Editor" && (
          <div>
            ...
            <ul className={`list-disc list-inside space-y-2 ${theme.textSecondary} mt-4`}>
              <li className="pt-2">Advanced syntax highlighting for over 20 programming languages.</li>
        ...
        {title === "Version Control" && (
          <div>
            ...
            <ul className={`list-disc list-inside space-y-2 ${theme.textSecondary} mt-4`}>
              <li className="pt-2">Create and manage branches to work on features independently.</li>
        ...
        {title === "Project Management" && (
          <div>
            ...
            <ul className={`list-disc list-inside space-y-2 ${theme.textSecondary} mt-4`}>
              <li className="pt-2">Drag-and-drop functionality for easy file organization.</li>
        ...
        {title === "AI Assistant" && (
          <div>
            ...
            <ul className={`list-disc list-inside space-y-2 ${theme.textSecondary} mt-4`}>
              <li className="pt-2">Receive context-aware code suggestions to speed up development.</li>
        ...
        {title === "Live Chat" && (
          <div>
            ...
            <ul className={`list-disc list-inside space-y-2 ${theme.textSecondary} mt-4`}>
              <li className="pt-2">Instant messaging for quick communication.</li>
              <li>Share code snippets in the chat.</li>
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <ul className={`list-disc list-inside space-y-2 ${theme.textSecondary}`}>
                ...
                <li>
                  <strong>Supabase Database:</strong> Serves as the primary backend database for authentication, real-time data synchronization, and storage management.
               </li>
                <li>
                  <strong>Nginx:</strong> Functions as a reverse proxy and load balancer, managing traffic distribution, enhancing security, and optimizing server performance.
                </li>
                <li>
            ...
            <div className="mt-4">
              ...
              <p className={theme.textSecondary}>
                The architecture leverages containerization and orchestration tools like Docker  to ensure scalability. Each microservice can be independently scaled based on demand, and fault tolerance is achieved through redundancy and health checks.
              </p>
            </div>
            <div className="mt-4">
              <img
